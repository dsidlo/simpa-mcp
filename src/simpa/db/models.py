...
class RefinedPrompt(Base):
    ...
    prior_refinement_id: Mapped[int | None] = mapped_column(
        Integer,
    ...
    score_dist_1: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    score_dist_2: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    score_dist_3: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    score_dist_4: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    score_dist_5: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
